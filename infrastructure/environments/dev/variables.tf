...
################################################################################
# AWS Docs MCP Server Runtime
################################################################################

variable "create_aws_docs_mcp_runtime" {
  description = "Whether to create the AgentCore Runtime for the AWS Docs MCP Server."
  type        = bool
  default     = false
}

variable "aws_docs_mcp_ecr_repository_name" {
  description = "Name of the ECR repository for the AWS Docs MCP Server container image."
  type        = string
  default     = ""
}

variable "aws_docs_mcp_container_image_tag" {
  description = "Container image tag for the AWS Docs MCP Server."
  type        = string
  default     = "latest"
}

variable "aws_docs_mcp_runtime_name" {
  description = "Name of the AgentCore Runtime for the AWS Docs MCP Server."
  type        = string
  default     = ""
}

variable "aws_docs_mcp_runtime_description" {
  description = "Description of the AWS Docs MCP Server runtime."
  type        = string
  default     = "AgentCore Runtime for the AWS Documentation MCP Server"
}
...
variable "gateway_authorizer_type" {
  description = "Authorizer type: CUSTOM_JWT, AWS_IAM, or NONE."
  type        = string
  default     = "NONE"
}

variable "gateway_protocol_configuration" {
  description = "MCP protocol configuration for the gateway."
  type = object({
...
variable "gateway_exception_level" {
  description = "Exception level for gateway logging. Set to DEBUG to enable detailed logs."
  type        = string
  default     = null
}
